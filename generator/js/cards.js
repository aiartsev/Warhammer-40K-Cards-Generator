...
function card_element_ministats(params, card_data, options) {
    var stats = [4, 4, 4, 4, 4, 1, 4, 1, 8];
    for (var i = 0; i < 9; ++i) {
        stats[i] = parseInt(params[i], 10) || 0;
    }
    ...
    result += '<table class="card-stats">';
    result += '    <tbody><tr>';
    result += '      <th class="card-wh-mini-stats-header">Mv</th>';
    result += '      <th class="card-wh-mini-stats-header">WS</th>';
    result += '      <th class="card-wh-mini-stats-header">BS</th>';
    result += '      <th class="card-wh-mini-stats-header">S</th>';
    result += '      <th class="card-wh-mini-stats-header">T</th>';
    result += '      <th class="card-wh-mini-stats-header">W</th>';
    result += '      <th class="card-wh-mini-stats-header">I</th>';
    result += '      <th class="card-wh-mini-stats-header">A</th>';
    result += '      <th class="card-wh-mini-stats-header">Ld</th>';
    result += '    </tr>';
    result += '    <tr>';
...
function card_element_rangedweapon(params, card_data, options) {
    var stats = [0, 12, 24, 0, 0, 4, 1, 0, 5];
    for (var i = 0; i < 9; ++i) {
        parameter = parseInt(params[i], 10) || 0;
        if (i == 3 || i == 4) {
            if (parameter == 0) {
                parameter = "-";
            } else if (parameter > 0) {
    ...
    result += '<table class="card-stats">';
    result += '    <tbody><tr>';
    result += '      <th colspan="2" class="card-ranged-weapon-text card-ranged-weapon-range-header">⌐Range¬</th>';
    result += '      <th colspan="2" class="card-ranged-weapon-text card-ranged-weapon-range-header">⌐To Hit¬</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">S</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">D</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">SM</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">AR</th>';
    result += '    </tr>';
    result += '    <tr>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[0] + '-' + stats[1] + '"' + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[1] + '-' + stats[2] + '"' + '</td>';
    result += '      <td class="card-ranged-weapon-text card-wh-range-stat-left">' + stats[3] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-wh-range-stat-right">' + stats[4] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[5] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[6] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[7] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[8] + '+' + '</td>';
    result += '    </tr>';
    result += '  </tbody>';
    result += '</table>';
    return result;
...
function card_element_meleeweapon(params, card_data, options) {
    var stats = [4, 1, 0];
    for (var i = 0; i < 3; ++i) {
        // parameter = parseInt(params[i], 10) || 0;
        // if (i == 3 || i == 4 || i == 7 || i == 8) {
    ...
    result += '<table class="card-stats">';
    result += '    <tbody><tr>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">Range</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">Str.</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">Dam.</th>';
    result += '      <th class="card-ranged-weapon-text card-wh-mini-stats-header">S. Mod.</th>';
    result += '    </tr>';
    result += '    <tr>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + 'CC' + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[0] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + stats[1] + '</td>';
    result += '      <td class="card-ranged-weapon-text card-stats-cell">' + '-' + stats[2] + '</td>';
    result += '    </tr>';
    result += '  </tbody>';
    result += '</table>';
    return result;
...
var card_element_generators = {
    ...
    ministats: card_element_ministats,
    rangedweapon: card_element_rangedweapon,
    meleeweapon: card_element_meleeweapon,
